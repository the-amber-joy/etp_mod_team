...
export class OffenderService {
    ...
    updateStatus(body: { _id: number, notes: Note[], points: number, isBanned: boolean, updated: Date, updatedBy: Admin, bannedBy: Admin, dateBanned: Date }): Observable<Offender> {
